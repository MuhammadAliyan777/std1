...
$sql = "SELECT * FROM teacherprofile_tbl";
...
if(isset($_POST["btn"]))
{
    ...
    $sql2 = "INSERT INTO `teacherprofile_tbl`(`ID`, `NAME`, `CLASS`, `GENDER`, `cnic`) VALUES (NOT NULL,'$a',$b,'$c',$d)";
...
?>
  ...
  <div class="mb-3">
    <input type="number" name = "class" min="1" max="10" placeholder="Enter Class which you teach" class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
    <input type="text" name = "gender"  placeholder="Enter Your Gender" class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
    <input type="number" name = "cnic"  placeholder="Enter Your cnic" class="form-control" id="exampleInputPassword1">
  </div>
